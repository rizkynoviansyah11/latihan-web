                ...
                <div class="card shadow-sm">
                    ...
                    <form action="{{ route('destinations.update', $destination->id) }}" method="POST" class="form-floating">
                        ...
                        <div class="form-floating mb-3">
                            <input type="file" class="form-control" id="floatInput" placeholder="Image" name="image"
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" placeholder="Asia Heritage"
                                name="name" @error('name') is-invalid @enderror value="{{ $destination->name }}"
                                required>
                            <label for="name">Nama Destinasi</label>
                        </div>
                        <div class="form-floating">
                            <textarea name="description" class="form-control" id="" placeholder="Description"
                                @error('description') is-invalid @enderror required>{{ $destination->description }}</textarea>
                            <label for="floatingPassword">Description</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" placeholder="Location"
                                name="location" @error('location') is-invalid @enderror value="{{ $destination->location }}"
                                required>
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" placeholder="Senin - Jumat"
                                ...
                                value="{{ $destination->working_days }}" required>
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" placeholder="08:00 - 18:00"
                                ...
                                value="{{ $destination->working_hours }}" required>
